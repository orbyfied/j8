...
public abstract class CommandManager {
    ...
    /**
     * The translator for format specifiers.
     */
    protected Function<String, Object> formatTranslator;
    ...
    public String translateFormatting(String str) {
        return Text.translate(formatTranslator, str);
    }
        ...
        try {
            ...
            if (e instanceof CommandHaltException ec) {
                ...
                if (ec.getMessage() != null || ec.getCause() != null) {
                    ...
                    if (success)
                        b.append("" + Text.BOLD + "✔ " + Text.GREEN);
                    else
                        b.append(Text.RED + "" + Text.BOLD + "✖ " + Text.RED);
                    if (ec.getMessage() != null)
                        b.append(Text.literal(ec.getMessage()));
